# This R file (cnv.R) contains code sourced from the open-source project [Delly].
# The GitHub link of the open-source project: https://github.com/dellytools/delly
